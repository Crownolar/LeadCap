...
//     console.log("Derived totalCount from stats:", derivedTotalCount);
//     console.log("Derived totalPages from stats:", derivedTotalPages);
...
//   const getVerificationBadgeClass = (status) => {
//     if (status === "VERIFIED_ORIGINAL") {
//       return "border border-green-200 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 dark:border-green-900/40";
//     }
//     if (status === "VERIFIED_FAKE") {
//       return "border border-red-200 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 dark:border-red-900/40";
//     }
//     return "border border-gray-200 bg-gray-50 dark:bg-gray-900/30 text-gray-700 dark:text-gray-300 dark:border-gray-700";
//   };

//   const getReadingStatusClass = (status) => {
//     if (status === "SAFE") {
//       return "border border-green-200 bg-green-50 text-green-700 dark:bg-green-900/30 dark:text-green-300 dark:border-green-900/40";
//     }
//     if (status === "CONTAMINATED" || status === "FAILED") {
//       return "border border-red-200 bg-red-50 text-red-700 dark:bg-red-900/30 dark:text-red-300 dark:border-red-900/40";
//     }
//     if (status === "MODERATE") {
//       return "border border-amber-200 bg-amber-50 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300 dark:border-amber-900/40";
//     }
//     return "border border-gray-200 bg-gray-50 text-gray-700 dark:bg-gray-900/30 dark:text-gray-300 dark:border-gray-700";
//   };
...
//       {bulkSelection.size > 0 && (
//         <div
//           className={`${theme?.card} border ${theme?.border} rounded-2xl p-4 sm:p-5 shadow-sm flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4`}
//         >
...
//               onClick={() => handleBulkAction("APPROVED")}
//               disabled={bulkProcessing}
//               className='flex-1 lg:flex-none rounded-xl bg-green-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-green-700 disabled:bg-gray-400'
//             >
//               Approve
//             </button>
//             <button
//               onClick={() => handleBulkAction("FLAGGED")}
//               disabled={bulkProcessing}
//               className='flex-1 lg:flex-none rounded-xl bg-amber-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-amber-700 disabled:bg-gray-400'
//             >
//               Flag
//             </button>
//             <button
//               onClick={() => setBulkSelection(new Set())}
//               disabled={bulkProcessing}
//               className='flex-1 lg:flex-none rounded-xl bg-gray-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-gray-700 disabled:bg-gray-400'
//             >
//               Clear
//             </button>
//           </div>
...
//         {/* Left list panel */}
//         <div
//           className={`${theme?.card} rounded-2xl p-5 sm:p-6 border ${theme?.border} shadow-sm`}
//         >
//           <div className='mb-5 flex items-center justify-between gap-3'>
//             <div>
//               <h3 className='text-lg font-semibold tracking-tight inline-flex items-center gap-2'>
//                 {filterStatus}
//                 <span className='inline-flex items-center justify-center min-w-[1.75rem] h-6 px-2 rounded-full text-xs font-bold border border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-900/40 dark:bg-emerald-900/20 dark:text-emerald-300'>
//                   {totalCount}
//                 </span>
//               </h3>
//               <p className={`text-xs mt-1 ${theme?.textMuted}`}>
...
//             {samples.length > 0 && (
//               <label className='flex items-center gap-2 text-xs sm:text-sm cursor-pointer font-medium'>
//                 <input
//                   type='checkbox'
//                   checked={
//                     samples.length > 0 && bulkSelection.size === samples.length
...
//                       : `${theme?.border} hover:shadow-md hover:-translate-y-[1px]`
//                   }`}
//                 >
...
//                           </p>
//                           <p
//                             className={`text-xs mt-1 ${theme?.textMuted} truncate`}
//                           >
//                             {sample.sampleId || "No Sample ID"}
//                           </p>
//                         </div>
...
//                           <span
//                             className={`text-[10px] px-2.5 py-1 rounded-full font-semibold whitespace-nowrap ${getVerificationBadgeClass(
//                               sample.verificationStatus,
//                             )}`}
//                           >
//                             {sample.verificationStatus || "UNVERIFIED"}
...
//                         <span className='text-[11px] px-2.5 py-1 rounded-full border border-blue-200 bg-blue-50 text-blue-700 dark:border-blue-900/40 dark:bg-blue-900/30 dark:text-blue-300'>
//                           {sample.state?.name || "No state"}
//                         </span>
//                         {sample.lga?.name && (
//                           <span className='text-[11px] px-2.5 py-1 rounded-full border border-purple-200 bg-purple-50 text-purple-700 dark:border-purple-900/40 dark:bg-purple-900/30 dark:text-purple-300'>
//                             {sample.lga.name}
//                           </span>
//                         )}
//                       </div>

//                       <p className={`text-xs mt-3 ${theme?.textMuted} truncate`}>
//                         by {sample.creator?.fullName || "Unknown collector"}
//                       </p>
//                     </button>
//                   </div>
...
//           <div className={`pt-4 mt-5 border-t ${theme?.border}`}>
//             <div className='flex items-center justify-between gap-2'>
//               <button
//                 onClick={() => setPage((prev) => Math.max(1, prev - 1))}
//                 disabled={page <= 1 || loading}
//                 className='px-3 py-2 rounded-xl border disabled:opacity-50 text-sm hover:bg-gray-50 dark:hover:bg-gray-800/40 transition'
//               >
//                 Prev
//               </button>
...
//           {selectedSample ? (
//             <div
//               className={`${theme?.card} rounded-2xl p-5 sm:p-6 border ${theme?.border} shadow-sm space-y-6`}
//             >
//               {totalInCurrentPage > 0 && (
//                 <div className='flex items-center justify-between gap-3'>
//                   <p className={`text-sm ${theme?.textMuted}`}>
//                     Sample {currentSampleIndex} of {totalInCurrentPage} on this
//                     page
//                   </p>

//                   <span
//                     className={`text-xs px-3 py-1 rounded-full font-semibold ${getVerificationBadgeClass(
...
//                 <div className='rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/40 sm:col-span-2 xl:col-span-1'>
//                   <div className='flex items-center gap-2 mb-2'>
//                     <MapPin size={16} className='text-emerald-600' />
//                     <p className='text-xs font-semibold uppercase tracking-wider'>
//                       Location
...
//               <div className='rounded-2xl border border-gray-200 overflow-hidden bg-gray-50 dark:border-gray-700 dark:bg-gray-800/30'>
//                 <div className='flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-white/60 dark:border-gray-700 dark:bg-gray-900/20'>
//                   <div className='flex items-center gap-2'>
//                     <ShieldCheck size={15} className='text-emerald-500' />
...
//                     <div
//                       key={reading.id}
//                       className='rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/40'
//                     >
//                       <div className='flex items-center justify-between gap-2 mb-3'>
...
//                         </p>
//                         <span
//                           className={`text-[11px] px-2.5 py-1 rounded-full font-semibold ${getReadingStatusClass(
//                             reading.status,
//                           )}`}
//                         >
//                           {reading.status}
...
//                       Select a decision, flag issues if necessary, and add notes.
//                     </p>
//                   </div>
//                 </div>
...
//                       <label
//                         key={issue}
//                         className='flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 px-3 py-2 text-xs sm:text-sm cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/40 transition'
//                       >
//                         <input
//                           type='checkbox'
//                           checked={reviewForm.issues.includes(issue)}
...
//                         : "Add notes or observations..."
//                     }
//                     className={`w-full px-4 py-3 text-sm sm:text-base border ${theme?.border} rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500 ${theme?.card}`}
//                   />
//                 </div>
...
//                     onClick={handleSubmitReview}
//                     disabled={reviewing}
//                     className='flex-1 inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-400 text-white font-semibold py-3 px-4 rounded-2xl transition-colors text-sm sm:text-base'
//                   >
//                     {reviewing ? "Submitting..." : "Submit Review"}
//                   </button>
...
//                       type='button'
//                       onClick={goToNextSample}
//                       className='inline-flex items-center justify-center gap-2 px-4 py-3 border border-emerald-600 text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 rounded-2xl font-semibold text-sm sm:text-base transition-colors'
//                     >
//                       Next sample
...
//           ) : (
//             <div
//               className={`rounded-2xl p-8 border ${theme?.border} text-center min-h-[260px] flex flex-col items-center justify-center shadow-sm ${
//                 samples.length === 0
//                   ? "bg-transparent border-dashed"
//                   : theme?.card
//               }`}
