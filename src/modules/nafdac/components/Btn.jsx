...
const Btn = ({ children, variant = "primary", onClick, icon, small }) => {
  const base = `inline-flex items-center gap-2 font-semibold rounded-xl transition-all ${small ? "text-xs px-3 py-1.5" : "text-sm px-4 py-2.5"}`;
  const variants = {
