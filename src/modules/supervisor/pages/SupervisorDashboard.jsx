...
const SupervisorDashboard = () => {
  ...
  const { stats, collectors, loading, error } =
  ...
  const activeCollectors = collectors.filter(
    (collector) => collector.isActive
  );

  const inactiveCollectors =
    collectors.length - activeCollectors.length;
    ...
    <div className={`space-y-6 pb-8 ${theme.text}`}>
      ...
      <section className="relative overflow-hidden rounded-[28px] border border-emerald-200/70 bg-gradient-to-br from-emerald-50 via-white to-teal-50 p-6 shadow-sm dark:border-emerald-900/40 dark:from-emerald-950/40 dark:via-gray-900 dark:to-teal-950/30 md:p-8">
        ...
        <div className="relative flex flex-col gap-7 xl:flex-row xl:items-end xl:justify-between">
          ...
          <div className="max-w-3xl">
            ...
            <p
              className={`mt-3 max-w-2xl text-sm leading-6 md:text-base ${theme.textMuted}`}
            >
              Monitor your field collectors, sample submissions,
              and review workload from one place.
            </p>
        ...
        {kpis.map((item) => {
          ...
          return (
            <button
              ...
              className="text-left"
            >
              <SurfaceCard className="group relative h-full overflow-hidden p-5 hover:-translate-y-0.5">
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div>
                    ...
                    <p
                      className={`mt-2 text-3xl font-bold tracking-tight ${item.valueClass}`}
                    >
                      {item.value}
                    </p>

                    <p
                      className={`mt-1.5 text-xs ${theme.textMuted}`}
                    >
                      {item.detail}
                    </p>
                  </div>
      ...
      <section className="grid grid-cols-1 gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        ...
        <SurfaceCard className="overflow-hidden p-0">
          ...
          <div
            className={`flex items-center justify-between border-b px-5 py-5 md:px-6 ${theme.border}`}
          >
          ...
          <div className="grid gap-5 p-5 md:grid-cols-2 md:p-6">
            ...
            <div className="flex min-h-[250px] items-center justify-center">
              ...
              {totalReviewItems > 0 ? (
                        ...
                        content={({
                          ...
                          payload?.[0] ? (
                            ...
                            >
                              ...
                              <span
                                className={`ml-2 ${theme.textMuted}`}
                              >
                                {payload[0].value}
                              </span>
                            </div>
                ...
                <div
                  className={`text-center text-sm ${theme.textMuted}`}
                >
              ...
              {reviewRows.map((row) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center justify-between rounded-2xl border px-3.5 py-3 text-left transition hover:-translate-y-0.5 hover:shadow-sm ${theme.border} ${theme.bg}`}
                  >
        ...
        <SurfaceCard className="p-0">
          ...
          <div
            className={`border-b px-5 py-5 md:px-6 ${theme.border}`}
          >
            <div className="flex items-center gap-2">
            ...
            {[
              {
                ...
                description:
                  "Open pending and completed reviews",
                icon: ClipboardCheck,
                route: "/sample-review",
              },
              {
      ...
      <SurfaceCard className="overflow-hidden p-0">
        ...
        <div
          className={`flex flex-col gap-4 border-b px-5 py-5 md:flex-row md:items-center md:justify-between md:px-6 ${theme.border}`}
        >
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p
                  className={`mt-1 text-xs ${theme.textMuted}`}
                >
                  Highest sample activity across your field team.
                </p>
              </div>
          ...
          <button
            ...
            className="inline-flex items-center gap-1 self-start text-xs font-bold text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 md:self-auto"
          >
            View all
        ...
        {topCollectors.length === 0 ? (
          ...
          <div
            className={`px-6 py-14 text-center ${theme.textMuted}`}
          >
                          ...
                          <td className="px-6 py-4">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div className="min-w-0">
                                ...
                                <p
                                  className={`mt-0.5 truncate text-xs ${theme.textMuted}`}
                                >
                                  {collector.email}
                                </p>
                ...
                (collector, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full p-4 text-left transition hover:bg-gray-50 dark:hover:bg-gray-800/30`}
                    >
                      ...
                      <div className="mt-4 grid grid-cols-3 gap-2">
                        ...
                        <div
                          className={`rounded-xl border p-2.5 ${theme.border} ${theme.bg}`}
                        >
                          <p
                            className={`text-[10px] uppercase tracking-wide ${theme.textMuted}`}
                          >
                            Samples
                          </p>
